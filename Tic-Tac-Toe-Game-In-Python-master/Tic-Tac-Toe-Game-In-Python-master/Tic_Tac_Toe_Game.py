...
# i have made the chang
root=Tk()
root.title("Tic Tac Toe")
#add Buttons
bu1=ttk.Button(root,text=' ')
bu1.grid(row=0,column=0,sticky='snew',ipadx=40,ipady=40)
bu1.config(command=lambda: ButtonClck(1))

bu2=ttk.Button(root,text=' '
    "--dir",
   =1,sticky='snew',ipadx=40,ipady=40)
bu2.config(command=lambda: ButtonClic
bu2.grid(row=0,column=1,self._time = time.perf_counter()ew',ipadx=40,ipady=40)
